...
const navigation = [
  ...
  { name: 'Club Finder', href: '#', icon: UserPlusIcon, current: true },
]
      ...
      <div>
        ...
        <div className="flex flex-1 flex-col md:pl-64">
          ...
          <main className="flex-1">
            <div className="py-6">
              <div className="mx-auto max-w-2xl px-4 sm:px-6 md:px-8 flex flex-col content-center py-12">
              <h1 className="text-4xl font-semibold text-gray-900 text-center">Find Clubs</h1>
                {/* Replace with your content */}
                <div className='w-full '>
                    <div className="relative mt-1 rounded-md shadow-sm py-6">
